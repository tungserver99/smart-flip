...
def main():
    parser = argparse.ArgumentParser(
        description="Group-Wise AWQ with ASYMMETRIC quantization + L2 Salience for Mistral-7B",
    ...
    # CHANGED DEFAULT: 50 -> 16 for Mistral 7B (Hidden dim 4096 uses much more RAM)
    parser.add_argument("--layer-batch-size", type=int, default=16,
                       help="Number of layers to calibrate simultaneously. "
                            "Mistral-7B requires smaller batches than MiniCPM due to larger hidden dim.")
    ...
    print(f"Layer Batch Size: {args.layer_batch_size} (Adjusted for 7B memory footprint)")
    print("=" * 80)
